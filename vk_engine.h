...
void VulkanEngine::init_swapchain()
{
	...
	std::cout << "init_swapchain() took " << duration << " milliseconds.\n";
}
...
void VulkanEngine::init_commands()
{
	...
	std::cout << "init_commands() took " << duration << " microseconds.\n";
}
...
void VulkanEngine::init_sync_structures()
{
	...
	std::cout << "init_synch_structures() took " << duration << " microseconds.\n";
...
//< frame_desc
	...
	std::cout << "init_descriptors() took " << duration << " microseconds.\n";
